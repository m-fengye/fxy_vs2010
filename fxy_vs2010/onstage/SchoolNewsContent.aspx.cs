...
{
    public partial class SchoolNewsContent : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (ID != null)
                {
                    ...
                    //更新浏览量
                    AccessDBHelper.Update("update SchoolNews set LookNum=" + (Convert.ToInt32(ds.Tables[0].Rows[0]["LookNum"]) + 1) + " where ID=" + ID);
                    ...
                    PHSchoolNewsContent.Controls.Add(c);
