...
{
    public partial class PublicInfoContent : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (ID != null)
                {
                    ...
                    //更新浏览量
                    AccessDBHelper.Update("update PublicInfo set LookNum=" + (Convert.ToInt32(ds.Tables[0].Rows[0]["LookNum"]) + 1) + " where ID=" + ID);
                    ...
                    PHPublicInfoContent.Controls.Add(c);
